...
## builds
We use guix as the build orchestrator, delegating to already-integrated platform build systems (mvn, meson/cmake, cargo, node, cl-asdf) for builds. This gets us quite a lot:
